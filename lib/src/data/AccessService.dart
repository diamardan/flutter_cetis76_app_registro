...
import 'package:cetis76_app_registro/src/models/acceses_model.dart';
import 'package:cetis76_app_registro/src/utils/net_util.dart';
import 'package:http/http.dart' as http;

class AccessService {
  getAll() async {
    String endpoint = AppConstants.backendUrl + '/cetis76/accesos/getAll';
  ...
  getAllById(String idbio) async {
    String endpoint = AppConstants.backendUrl + '/cetis76/accesos/getAllById';
    var uri = Uri.parse(endpoint);
    Map<String, String> headers = {
      "Content-type": "application/json; charset=UTF-8"
    };
